...
const ChatSuggestions = ({
  ...
  switch (variant) {
    case 'home':
      // Home page styling with improved wrapping
      containerStyle = "w-full my-6 flex flex-wrap justify-center items-center gap-3";
      buttonStyle = "flex-shrink-0 text-center bg-navy-900/40 hover:bg-navy-800 text-foreground rounded-full px-4 py-3 flex items-center justify-center transition-colors border border-navy-700/50 shadow-sm max-w-full whitespace-normal break-words";
      break;
      
    case 'chat':
      // Chat UI styling with improved wrapping
    ...
    default:
      // Default styling with improved wrapping
